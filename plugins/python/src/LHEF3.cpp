...
// Pythia8::WeightsShower file:Pythia8/Weights.h line:131
...
// Pythia8::WeightsSimpleShower file:Pythia8/Weights.h line:150
struct PyCallBack_Pythia8_WeightsSimpleShower : public Pythia8::WeightsSimpleShower {
	...
	void clear() override { 
		...
		return WeightsSimpleShower::clear();
	}
	void bookVectors(class std::vector<double, class std::allocator<double> > a0, class std::vector<class std::basic_string<char>, class std::allocator<class std::basic_string<char> > > a1) override { 
		pybind11::gil_scoped_acquire gil;
		...
		return WeightsSimpleShower::bookVectors(a0, a1);
	}
	void collectWeightNames(class std::vector<class std::basic_string<char>, class std::allocator<class std::basic_string<char> > > & a0) override { 
		pybind11::gil_scoped_acquire gil;
...
void bind_Pythia8_LHEF3(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // Pythia8::WeightsBase file:Pythia8/Weights.h line:35
		...
		cl.def("bookVectors", (void (Pythia8::WeightsBase::*)(class std::vector<double, class std::allocator<double> >, class std::vector<std::string, class std::allocator<std::string > >)) &Pythia8::WeightsBase::bookVectors, "C++: Pythia8::WeightsBase::bookVectors(class std::vector<double, class std::allocator<double> >, class std::vector<std::string, class std::allocator<std::string > >) --> void", pybind11::arg(""), pybind11::arg(""));
	...
	{ // Pythia8::WeightsSimpleShower file:Pythia8/Weights.h line:150
		...
		cl.def("clear", (void (Pythia8::WeightsSimpleShower::*)()) &Pythia8::WeightsSimpleShower::clear, "C++: Pythia8::WeightsSimpleShower::clear() --> void");
		cl.def("bookVectors", (void (Pythia8::WeightsSimpleShower::*)(class std::vector<double, class std::allocator<double> >, class std::vector<std::string, class std::allocator<std::string > >)) &Pythia8::WeightsSimpleShower::bookVectors, "C++: Pythia8::WeightsSimpleShower::bookVectors(class std::vector<double, class std::allocator<double> >, class std::vector<std::string, class std::allocator<std::string > >) --> void", pybind11::arg("weights"), pybind11::arg("names"));
		...
		cl.def("replaceWhitespace", (void (Pythia8::WeightsSimpleShower::*)(class std::vector<std::string, class std::allocator<std::string > > &)) &Pythia8::WeightsSimpleShower::replaceWhitespace, "C++: Pythia8::WeightsSimpleShower::replaceWhitespace(class std::vector<std::string, class std::allocator<std::string > > &) --> void", pybind11::arg("namesIn"));

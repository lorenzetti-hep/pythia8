...
void bind_Pythia8_PythiaStdlib(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// Pythia8::toLower(const std::string &, bool) file:Pythia8/PythiaStdlib.h line:189
	...
	// Pythia8::toLowerRep(std::string &, bool) file:Pythia8/PythiaStdlib.h line:192

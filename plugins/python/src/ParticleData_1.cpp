...
void bind_Pythia8_ParticleData_1(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // Pythia8::ParticleData file:Pythia8/ParticleData.h line:423
		...
		cl.def("initWidths", (void (Pythia8::ParticleData::*)(class std::vector<class Pythia8::ResonanceWidths *, class std::allocator<class Pythia8::ResonanceWidths *> >)) &Pythia8::ParticleData::initWidths, "C++: Pythia8::ParticleData::initWidths(class std::vector<class Pythia8::ResonanceWidths *, class std::allocator<class Pythia8::ResonanceWidths *> >) --> void", pybind11::arg("resonancePtrs"));
		...
		cl.def("setResonancePtr", (void (Pythia8::ParticleData::*)(int, class Pythia8::ResonanceWidths *)) &Pythia8::ParticleData::setResonancePtr, "C++: Pythia8::ParticleData::setResonancePtr(int, class Pythia8::ResonanceWidths *) --> void", pybind11::arg("idIn"), pybind11::arg("resonancePtrIn"));

...
// Pythia8::StringFragmentation file:Pythia8/StringFragmentation.h line:104
...
void bind_Pythia8_StringFragmentation(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // Pythia8::StringFragmentation file:Pythia8/StringFragmentation.h line:104
		...
		cl.def("fragment", (bool (Pythia8::StringFragmentation::*)(int, class Pythia8::ColConfig &, class Pythia8::Event &)) &Pythia8::StringFragmentation::fragment, "C++: Pythia8::StringFragmentation::fragment(int, class Pythia8::ColConfig &, class Pythia8::Event &) --> bool", pybind11::arg("iSub"), pybind11::arg("colConfig"), pybind11::arg("event"));
		cl.def("junctionRestFrame", (class Pythia8::RotBstMatrix (Pythia8::StringFragmentation::*)(class Pythia8::Vec4 &, class Pythia8::Vec4 &, class Pythia8::Vec4 &)) &Pythia8::StringFragmentation::junctionRestFrame, "C++: Pythia8::StringFragmentation::junctionRestFrame(class Pythia8::Vec4 &, class Pythia8::Vec4 &, class Pythia8::Vec4 &) --> class Pythia8::RotBstMatrix", pybind11::arg("p0"), pybind11::arg("p1"), pybind11::arg("p2"));

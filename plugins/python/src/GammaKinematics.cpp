...
void bind_Pythia8_GammaKinematics(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // Pythia8::PhaseSpace file:Pythia8/PhaseSpace.h line:42
		...
		cl.def("init", (void (Pythia8::PhaseSpace::*)(bool, class Pythia8::SigmaProcess *)) &Pythia8::PhaseSpace::init, "C++: Pythia8::PhaseSpace::init(bool, class Pythia8::SigmaProcess *) --> void", pybind11::arg("isFirst"), pybind11::arg("sigmaProcessPtrIn"));

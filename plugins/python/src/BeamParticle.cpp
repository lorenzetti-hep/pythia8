...
void bind_Pythia8_BeamParticle(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // Pythia8::BeamParticle file:Pythia8/BeamParticle.h line:133
		...
		cl.def("resolvedGamma", (bool (Pythia8::BeamParticle::*)()) &Pythia8::BeamParticle::resolvedGamma, "C++: Pythia8::BeamParticle::resolvedGamma() --> bool");
		...
		cl.def("getGammaMode", (int (Pythia8::BeamParticle::*)()) &Pythia8::BeamParticle::getGammaMode, "C++: Pythia8::BeamParticle::getGammaMode() --> int");
		cl.def("isResolvedUnresolved", (bool (Pythia8::BeamParticle::*)()) &Pythia8::BeamParticle::isResolvedUnresolved, "C++: Pythia8::BeamParticle::isResolvedUnresolved() --> bool");
		...
		cl.def("gammaInBeam", (bool (Pythia8::BeamParticle::*)()) &Pythia8::BeamParticle::gammaInBeam, "C++: Pythia8::BeamParticle::gammaInBeam() --> bool");

...
{
	{ // Pythia8::Plugin file:Pythia8/Info.h line:769
		pybind11::class_<Pythia8::Plugin, std::shared_ptr<Pythia8::Plugin>> cl(M("Pythia8"), "Plugin", "");
		pybind11::handle cl_type = cl;

		cl.def( pybind11::init( [](){ return new Pythia8::Plugin(); } ), "doc" );
		cl.def( pybind11::init( [](class std::basic_string<char> const & a0){ return new Pythia8::Plugin(a0); } ), "doc" , pybind11::arg("nameIn"));
		cl.def( pybind11::init<std::string, class Pythia8::Info *>(), pybind11::arg("nameIn"), pybind11::arg("infoPtrIn") );

		cl.def( pybind11::init( [](Pythia8::Plugin const &o){ return new Pythia8::Plugin(o); } ) );
		cl.def("isLoaded", (bool (Pythia8::Plugin::*)()) &Pythia8::Plugin::isLoaded, "C++: Pythia8::Plugin::isLoaded() --> bool");
		cl.def("errorMsg", (void (Pythia8::Plugin::*)(std::string)) &Pythia8::Plugin::errorMsg, "C++: Pythia8::Plugin::errorMsg(std::string) --> void", pybind11::arg("errMsg"));
	}

...
// Pythia8::PomH1FitAB file:Pythia8/PartonDistributions.h line:635
...
// Pythia8::PomH1Jets file:Pythia8/PartonDistributions.h line:682
...
// Pythia8::PomHISASD file:Pythia8/PartonDistributions.h line:728
...
// Pythia8::Lepton file:Pythia8/PartonDistributions.h line:775
...
// Pythia8::LeptonPoint file:Pythia8/PartonDistributions.h line:815
...
// Pythia8::NeutrinoPoint file:Pythia8/PartonDistributions.h line:834
...
// Pythia8::CJKL file:Pythia8/PartonDistributions.h line:854
...
// Pythia8::Lepton2gamma file:Pythia8/PartonDistributions.h line:908
...
// Pythia8::GammaPoint file:Pythia8/PartonDistributions.h line:953
...
// Pythia8::Proton2gammaDZ file:Pythia8/PartonDistributions.h line:973
...
// Pythia8::Nucleus2gamma file:Pythia8/PartonDistributions.h line:997
...
// Pythia8::EPAexternal file:Pythia8/PartonDistributions.h line:1029
...
void bind_Pythia8_PartonDistributions_1(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // Pythia8::PomH1FitAB file:Pythia8/PartonDistributions.h line:635
		...
		cl.def( pybind11::init( [](int const & a0, int const & a1, double const & a2, class std::basic_string<char> const & a3){ return new Pythia8::PomH1FitAB(a0, a1, a2, a3); }, [](int const & a0, int const & a1, double const & a2, class std::basic_string<char> const & a3){ return new PyCallBack_Pythia8_PomH1FitAB(a0, a1, a2, a3); } ), "doc");
		cl.def( pybind11::init<int, int, double, std::string, class Pythia8::Info *>(), pybind11::arg("idBeamIn"), pybind11::arg("iFit"), pybind11::arg("rescaleIn"), pybind11::arg("pdfdataPath"), pybind11::arg("infoPtr") );

		cl.def( pybind11::init( [](int const & a0, double const & a1, class std::basic_istream<char> & a2){ return new Pythia8::PomH1FitAB(a0, a1, a2); }, [](int const & a0, double const & a1, class std::basic_istream<char> & a2){ return new PyCallBack_Pythia8_PomH1FitAB(a0, a1, a2); } ), "doc");
		cl.def( pybind11::init<int, double, class std::basic_istream<char> &, class Pythia8::Info *>(), pybind11::arg("idBeamIn"), pybind11::arg("rescaleIn"), pybind11::arg("is"), pybind11::arg("infoPtr") );
	...
	{ // Pythia8::PomH1Jets file:Pythia8/PartonDistributions.h line:682
		...
		cl.def( pybind11::init( [](int const & a0, int const & a1, double const & a2, class std::basic_string<char> const & a3){ return new Pythia8::PomH1Jets(a0, a1, a2, a3); }, [](int const & a0, int const & a1, double const & a2, class std::basic_string<char> const & a3){ return new PyCallBack_Pythia8_PomH1Jets(a0, a1, a2, a3); } ), "doc");
		cl.def( pybind11::init<int, int, double, std::string, class Pythia8::Info *>(), pybind11::arg("idBeamIn"), pybind11::arg("iFit"), pybind11::arg("rescaleIn"), pybind11::arg("pdfdataPath"), pybind11::arg("infoPtr") );

		cl.def( pybind11::init( [](int const & a0, double const & a1, class std::basic_istream<char> & a2){ return new Pythia8::PomH1Jets(a0, a1, a2); }, [](int const & a0, double const & a1, class std::basic_istream<char> & a2){ return new PyCallBack_Pythia8_PomH1Jets(a0, a1, a2); } ), "doc");
		cl.def( pybind11::init<int, double, class std::basic_istream<char> &, class Pythia8::Info *>(), pybind11::arg("idBeamIn"), pybind11::arg("rescaleIn"), pybind11::arg("is"), pybind11::arg("infoPtr") );
	...
	{ // Pythia8::PomHISASD file:Pythia8/PartonDistributions.h line:728
		...
		cl.def( pybind11::init<int, class std::shared_ptr<class Pythia8::PDF>, class Pythia8::Settings &, class Pythia8::Info *>(), pybind11::arg("idBeamIn"), pybind11::arg("ppdf"), pybind11::arg("settings"), pybind11::arg("infoPtrIn") );
	...
	{ // Pythia8::EPAexternal file:Pythia8/PartonDistributions.h line:1029
		...
		cl.def( pybind11::init<int, double, class std::shared_ptr<class Pythia8::PDF>, class std::shared_ptr<class Pythia8::PDF>, class Pythia8::Info *>(), pybind11::arg("idBeamIn"), pybind11::arg("m2In"), pybind11::arg("gammaFluxPtrIn"), pybind11::arg("gammaPDFPtrIn"), pybind11::arg("infoPtrIn") );
		...
		cl.def("sampleQ2gamma", (double (Pythia8::EPAexternal::*)(double)) &Pythia8::EPAexternal::sampleQ2gamma, "C++: Pythia8::EPAexternal::sampleQ2gamma(double) --> double", pybind11::arg(""));

...
// Pythia8::nPDF file:Pythia8/PartonDistributions.h line:1093
...
// Pythia8::Isospin file:Pythia8/PartonDistributions.h line:1143
...
// Pythia8::EPS09 file:Pythia8/PartonDistributions.h line:1159
...
// Pythia8::EPPS16 file:Pythia8/PartonDistributions.h line:1200
...
void bind_Pythia8_PartonDistributions_2(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // Pythia8::EPS09 file:Pythia8/PartonDistributions.h line:1159
		...
		cl.def( pybind11::init( [](int const & a0, int const & a1, int const & a2, class std::basic_string<char> const & a3){ return new Pythia8::EPS09(a0, a1, a2, a3); }, [](int const & a0, int const & a1, int const & a2, class std::basic_string<char> const & a3){ return new PyCallBack_Pythia8_EPS09(a0, a1, a2, a3); } ), "doc");
		cl.def( pybind11::init( [](int const & a0, int const & a1, int const & a2, class std::basic_string<char> const & a3, class std::shared_ptr<class Pythia8::PDF> const & a4){ return new Pythia8::EPS09(a0, a1, a2, a3, a4); }, [](int const & a0, int const & a1, int const & a2, class std::basic_string<char> const & a3, class std::shared_ptr<class Pythia8::PDF> const & a4){ return new PyCallBack_Pythia8_EPS09(a0, a1, a2, a3, a4); } ), "doc");
		cl.def( pybind11::init<int, int, int, std::string, class std::shared_ptr<class Pythia8::PDF>, class Pythia8::Info *>(), pybind11::arg("idBeamIn"), pybind11::arg("iOrderIn"), pybind11::arg("iSetIn"), pybind11::arg("pdfdataPath"), pybind11::arg("protonPDFPtrIn"), pybind11::arg("infoPtrIn") );
	...
	{ // Pythia8::EPPS16 file:Pythia8/PartonDistributions.h line:1200
		...
		cl.def( pybind11::init( [](int const & a0, int const & a1, class std::basic_string<char> const & a2){ return new Pythia8::EPPS16(a0, a1, a2); }, [](int const & a0, int const & a1, class std::basic_string<char> const & a2){ return new PyCallBack_Pythia8_EPPS16(a0, a1, a2); } ), "doc");
		cl.def( pybind11::init( [](int const & a0, int const & a1, class std::basic_string<char> const & a2, class std::shared_ptr<class Pythia8::PDF> const & a3){ return new Pythia8::EPPS16(a0, a1, a2, a3); }, [](int const & a0, int const & a1, class std::basic_string<char> const & a2, class std::shared_ptr<class Pythia8::PDF> const & a3){ return new PyCallBack_Pythia8_EPPS16(a0, a1, a2, a3); } ), "doc");
		cl.def( pybind11::init<int, int, std::string, class std::shared_ptr<class Pythia8::PDF>, class Pythia8::Info *>(), pybind11::arg("idBeamIn"), pybind11::arg("iSetIn"), pybind11::arg("pdfdataPath"), pybind11::arg("protonPDFPtrIn"), pybind11::arg("infoPtrIn") );

...
// Pythia8::MultipartonInteractions file:Pythia8/MultipartonInteractions.h line:105
...
void bind_Pythia8_BeamRemnants(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // Pythia8::SigmaMultiparton file:Pythia8/MultipartonInteractions.h line:35
		...
		cl.def("sigmaSel", (class Pythia8::SigmaProcess * (Pythia8::SigmaMultiparton::*)()) &Pythia8::SigmaMultiparton::sigmaSel, "C++: Pythia8::SigmaMultiparton::sigmaSel() --> class Pythia8::SigmaProcess *", pybind11::return_value_policy::automatic);
